...
- **Потоковый вывод:** Реальное время отображения данных от LLM.
- **Приложение:** Построено с использованием Tauri.
- **Фронтенд:** Используется Vue.js вместе с Vuetify для создания современного интерфейса.
...
При разработке проекта используются следующие библиотеки, лицензии которых необходимо соблюдать:
